  ...
  const highlights = [
    {
      ...
      description: 'Deeply passionate about creating beautiful, intuitive user interfaces with modern technologies',
      color: 'text-blue-400',
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        <div className={`p-3 rounded-lg bg-white/10 ${highlight.color} group-hover:scale-110 transition-transform duration-300`}>
